...
step_trainer_trusted_node1703806516686 = glueContext.getSink(
...
step_trainer_trusted_node1703806516686.setCatalogInfo(
    catalogDatabase="database", catalogTableName="Step_trainer_trusted"
)
step_trainer_trusted_node1703806516686.setFormat("json")
step_trainer_trusted_node1703806516686.writeFrame(DropFields_node1703806230359)
job.commit()
