...
AmazonS3_node1703807741483 = glueContext.getSink(
...
AmazonS3_node1703807741483.setCatalogInfo(
    catalogDatabase="database", catalogTableName="customer_trusted"
)
AmazonS3_node1703807741483.setFormat("json")
AmazonS3_node1703807741483.writeFrame(DropFields_node1703807733818)
job.commit()
